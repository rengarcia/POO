...
public class frmSchweitzer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemRefrigerate = new javax.swing.JMenuItem();
        ...
        jMenuRoom.setText("Cliente");

        jMenu1.setText("Servicios");

        jMenuItem1.setText("Recargar");
        jMenu1.add(jMenuItem1);

        jMenuItemRefrigerate.setText("Congelar");
        jMenu1.add(jMenuItemRefrigerate);

        jMenuRoom.add(jMenu1);
    ...
    private javax.swing.JMenuItem jMenuItemRefrigerate;
